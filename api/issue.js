...
const { createIssue, getIssues, updateIssue, backlogIssues, getIssue, epicIssues, deleteIssue, getRoadmap } = require('../controllers/issue');
...
router.get("/:id", authenticateToken, async (req, res) => {
    try {
        ...
        const commentPermission = await canComment(req.params.id, req.user._id) ? true : false
