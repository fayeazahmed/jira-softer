			...
			<div className="App">
				...
				<div className="nav-padding" onClick={() => setNavModals({ projects: false, teams: false })}>
					...
					<Switch>
						...
						<PrivateRoute exact path="/projects/backlog/:id" component={Backlog} />
						<PrivateRoute exact path="/projects/boards/:id" component={Boards} />
						<PrivateRoute exact path="/projects/roadmap/:id" component={Roadmap} />
						<PrivateRoute exact path="/projects/settings/:id" component={ProjectSettings} />
