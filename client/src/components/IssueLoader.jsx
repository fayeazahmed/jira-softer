            ...
            <div className="issue__hero">
                <div>
                    <form className="issue__summary">
                        <input style={{ backgroundColor: "rgba(56, 56, 56, .3)" }} disabled />
                    </form>
                    <textarea className="mt-3" disabled></textarea>
                    <div className="issue__comments mt-3">
                        <textarea style={{ backgroundColor: "#e9e9e9" }} disabled></textarea>
                        <p className="protip"><strong>Pro tip:</strong> press M to comment</p>
                    </div>
                </div>
                <div className="ms-4">
